...
function populateMusic(response) {
	...
	for (i=0; i<l; i++) {
		...
		*/
		...
		+" type='music' class='fa fa-handshake-o spanCollaboration'"
		...
		*/
		...
		"<div class = 'musicContainer' style = 'width: 100%; height : 250px'>"
...
function addToFavorites(which, i) {
	...
	$.ajax(settings).done(function (response) {
		...
		if (response.added) which.setAttribute('class','fa fa-star spanFavourite');
		else which.setAttribute('class','fa fa-star spanFavourite estrellaFavorito');
